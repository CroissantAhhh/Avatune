    ...
    return (
        <div className="side-bar l-vertical">
            <div className="side-bar-upper l-vertical">
                <div className="side-bar-placeholder l-horizontal">
                    <img src="https://res.cloudinary.com/dmtj0amo0/image/upload/v1634329237/avatuneName_yipjwf.png" height="40px" alt="site logo" />
                </div>
                    ...
                    {playlistsTab ? (
                        ownPlaylists.slice(1).map(playlist => (
                            <div key={playlist.hashedId} className="playlist-listing-container hover-pointer">
                                <div className="playlist-listing" onClick={() => nextPath(`/playlist/${playlist.hashedId}`)}>
